/*
Phase-vocoder pitch shifter for Web Audio API (AudioWorkletProcessor).

Bundled from three sources (all open-source, redistributable):
  - fft.js         © Fedor Indutny, MIT License
                   https://github.com/indutny/fft.js
  - ola-processor  © Olivier Briand (olvb), Unlicense (public domain)
                   https://github.com/olvb/phaze
  - phase-vocoder  © Olivier Briand (olvb), Unlicense (public domain)
                   https://github.com/olvb/phaze

CommonJS module statements stripped; otherwise byte-for-byte identical.
Registers as "phase-vocoder-processor" with a single k-rate parameter:
  - pitchFactor  (default 1.0, range 0–∞, 2.0 = octave up, 0.5 = octave down)
*/
...
// ─── OLAProcessor (overlap-add base class) ─────────────────────────────────
...
class PhaseVocoderProcessor extends OLAProcessor {
  ...
  constructor(options) {
    options.processorOptions = { blockSize: BUFFERED_BLOCK_SIZE };
    super(options);
