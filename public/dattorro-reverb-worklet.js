...
Source: Jon Dattorro, "Effect Design Part 1: Reverberator and Other Filters"
JAES Vol.45, No.9, 1997 September.
Implementation: https://github.com/khoin/DattorroReverbNode
*/
...
class DattorroReverb extends AudioWorkletProcessor {
  static get parameterDescriptors() {
    return [
      ...
      name: x[0], defaultValue: x[1], minValue: x[2], maxValue: x[3], automationRate: x[4]
    }));
  }
  ...
  process(inputs, outputs, parameters) {
    ...
    while (i < 128) {
      ...
      const lo = this.readDelayAt(9,  this._taps[0])
      ...
      const ro = this.readDelayAt(5,  this._taps[7])
